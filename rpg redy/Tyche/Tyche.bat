@echo off
echo \---------------------------------------------------\
echo  \  Be aware of the magic                            \
echo   \---------------------------------------------------\
pause
:choosename
cls
echo Tyche. Oak: It seems I don't remember your name. What is it?
set /p name=
pause
...
::cls
::echo Tyche. Oak: Aah.. so you are a %gender%
::pause

cls
echo Tyche. Oak: So %name% what is your wish? 
pause
...
echo Tyche. Oak: Do you want to be reach?
echo Enter y to choose reach
pause
set /p yno=
...
echo Tyche. Oak: Do you want to be a celebity?
echo Enter y to choose celebity
pause
set /p yno=

if '%yno%' == 'y' (
    set starter=celebity
    goto chosen
)
...
echo Tyche. Oak: Do you want to be helthy for lifetime?
echo Enter y to choose helthy
pause
set /p yno=
...
cls
echo Tyche. Oak: Or.. wait.. there is one more.
pause
...
echo  \                   girls (Lvl 4)                 \
echo   \---------------------------------------------------\
echo Tyche. Oak: Do you want girls?
echo Be careful this with girls.
echo Enter y to choose girls
pause
set /p yno=
...
:chosen
cls
echo Tyche. Oak: Congrats! From here on you are on your one!
echo trust no one.
echo (do not trust girls)
echo Tyche. Oak: This will help you along the way.
pause


cls
echo Tyche. Oak: Now your journey begins with %starter%
echo Tyche. Oak: hew a good day.
echo Tyche. Oak: Good luck!
pause
...
if '%mom%' == '0' (
    ...
    echo Mom: These won't have any effect in city but I'm just giving it so you don't complain.
    set mom=1
    pause
    goto city1-1
)
...
echo.
echo You are inside the Hospital
echo Enter option number to pick an option (1,2,3)
echo 1) Get your healed by Nurse Joy
...
:city1-2-2
cls
echo %name%: Hey Joy, how about you show me your "tits" ;)
if '%leaguecup%' == '0' (
...
echo    )\  (\ (\ /)  )\ (\ )\  )\  )\  /( /( )\ )\ )\ )\ /(  (\
echo.
echo You stepped out of your town.
echo Since your town is very small you can already see your city.
echo your city is famous for their berries.
echo.
...
echo You are in city
echo Enter option number to pick an option (1,2,3,4)
echo 1) Talk to the Naiber
echo 2) Go near Home
echo 3) Go to the BAR
echo 4) Go to Stor
pause
set /p city2option=
