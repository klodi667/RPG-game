...
echo Welcome to Total WarV1.2.1, 
...
ping 129.190.0.3 -n 1 >nul

ping 129.131.0.3 -n 1 >nul

ping 155.178.0.3 -n 1 >nul

ping 128.38.0.0  -n 1 >nul
...
ping 157.150.0.3 -n 1 >nul

ping 158.13.0.3 -n 1 >nul

ping 157.153.0.3 -n 1 >nul

ping 129.51.0.3 -n 1 >nul
